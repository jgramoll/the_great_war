...
RSpec.describe GamesController, type: :routing do
  describe "routing" do
    ...
    it "routes to #show.json" do
      expect(:get => "/games/1.json").to route_to("games#show", :id => "1", format: "json")
    end
    ...
    it "routes to #update via PUT.json" do
      expect(:put => "/games/1.json").to route_to("games#update", :id => "1", format: "json")
    end
    ...
    it "routes to #update via PATCH.json" do
      expect(:patch => "/games/1.json").to route_to("games#update", :id => "1", format: "json")
    end
    ...
    it "routes to #destroy.json" do
      expect(:delete => "/games/1.json").to route_to("games#destroy", :id => "1", format: "json")
    end

    it "does not route to #new" do
      expect(:delete => "/games/1/new").to_not be_routable
    end

    it "does not route to #edit" do
      expect(:delete => "/games/1/edit").to_not be_routable
    end
  end
end
